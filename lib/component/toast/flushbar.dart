...
class Flushbar<T> extends StatefulWidget {
  ...
  route.FlushbarRoute? _flushbarRoute;

  /// Show the flushbar. Kicks in [FlushbarStatus.IS_APPEARING] state followed by [FlushbarStatus.SHOWING]
  Future show(BuildContext context) async {
    _flushbarRoute = route.showFlushbar(
      context: context,
      flushbar: this,
    );

    return Navigator.of(context, rootNavigator: false).push(_flushbarRoute!);
  }
...
class _FlushbarState<K extends Object?> extends State<Flushbar>
  ...
  void dispose() {
    ...
    widget.progressIndicatorController?.removeListener(() {
      _progressListener();
    });
